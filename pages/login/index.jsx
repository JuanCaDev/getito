...
export default function LoginPage() {
  ...
  const handleClick = () => {
    if (formValues.password === "pwd") {
      ...
      router.push(`http://auth.mercadolibre.com.ar/authorization?response_type=code&client_id=${process.env.APP_PUBLIC_ML_CLIENTE_ID}&redirect_uri=https://getito.vercel.app/token`)
    } else {
